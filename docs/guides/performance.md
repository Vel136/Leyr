...
| Shape | Static (us) | Dynamic (us) | Native (us) | Static speedup | Dynamic speedup |
|---|---:|---:|---:|---:|---:|
| Ball | 0.546 | 0.502 | 3.720 | 6.8x | 7.4x |
| Block | 0.794 | 0.815 | 2.983 | 3.8x | 3.7x |
| Cylinder | 0.732 | 0.726 | 3.054 | 4.2x | 4.2x |
| Wedge | 0.986 | 0.867 | 3.411 | 3.5x | 3.9x |
| CornerWedge | 0.757 | 0.808 | 3.004 | 4.0x | 3.7x |

Scaling test - N parts inserted, rays cast across the crowd, average cost per ray:

| N | Static (us) | Dynamic (us) | Native (us) | Static speedup |
|---:|---:|---:|---:|---:|
| 100 | 2.460 | 2.517 | 3.936 | 1.6x |
| 1,000 | 7.117 | 7.515 | 10.221 | 1.4x |
| 5,000 | 13.654 | 15.894 | 22.079 | 1.6x |
| 10,000 | 18.344 | 21.448 | 26.611 | 1.5x |
